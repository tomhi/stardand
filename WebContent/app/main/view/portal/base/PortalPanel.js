...
Ext.define('AM.main.view.portal.base.PortalPanel', {
	extend : 'Ext.panel.Panel',
	alias : 'widget.portalpanel',
	requires : [
		'Ext.layout.container.Column',
		'AM.main.view.portal.base.PortalDropZone',
	...
	initEvents : function () {
		this.callParent();
		this.dd = Ext.create('AM.main.view.portal.base.PortalDropZone', this, this.dropConfig);
	},
